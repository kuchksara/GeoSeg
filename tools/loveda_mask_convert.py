...
def parse_args():
    ...
    parser.add_argument("--mask-dir", default=data_root + "data/LoveDA/Train/Rural/masks_png")
    parser.add_argument("--output-mask-dir", default=data_root + "data/LoveDA/Train/Rural/masks_png_convert")

...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root=os.environ.get("base_data_path", "") + 'data/LoveDA/Train', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root=os.environ.get("base_data_path", "") + 'data/LoveDA/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root=os.environ.get("base_data_path", "") + 'data/LoveDA/Test', img_dir='images_png',
